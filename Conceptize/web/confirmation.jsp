...
<html>
    <head>
        ...
        <title>Conceptize | Confirmation</title>
...
<body>
    <div id="page-container">
        <div id="content-wrap">
            ...
            <% if (user != null && product != null && user.hasOrder(request.getParameter("pid"))) {%>
            <div class="container" style="padding:10px; background-color:white;box-shadow:5px 5px lightgray">
                <div style="text-align:center;">
                    <h5>Thanks,
                        <%if (session.getAttribute("LOGIN_USER") != null) {%>
                        <span id="confirmation-user" class="text-info"><%=user.getUid()%></span>!
                        <%} else {%>
                        <span id="confirmation-user" class="text-info">Guest</span>!
                        <%}%>
                    </h5>
                    You just bought, <a id="confirmation-product-title" style="color: #00cccc"><strong><%=product.getTitle()%></strong></a> by <a id="confirmation-product-seller" style="color: #00cccc"><%=product.getUid()%></a><br>
                    <strong>Total:</strong> <span id="confirmation-product-price"><%=product.getPrice()%></span>
            ...
            <div class="container" style="padding:10px; background-color:white;box-shadow:5px 5px lightgray">
                <div style="text-align:center;">
                    <h5>Sorry! No orders for this product has been made!</h5>
                    <div style="padding-top:10px">
                        <a href="index.jsp">
                            <button class="btn btn-secondary ">Continue Shopping</button>
                        </a>
