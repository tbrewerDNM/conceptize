                ...
                <form style="border-top:1px solid gray;padding:50px">
                    <div class="container">
                        <table id="create-product-pic-table">
                            <tr>
                            <div class="row">
                                <input id="input-image" class="form-control" placeholder="Upload Image URL" type="text" name="image"/>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-8 col-md-7 col-lg-8 col-xl-9">
                                <input id="input-title" class="form-control" placeholder="Title" type="text" name="title"/>
                            </div>
                            <div class="col-sm-4 col-md-5 col-lg-4 col-xl-3">
                                <input id="input-price" class="form-control" placeholder="Price" type="text" name="price"/>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="container">
                        <div class="row">
                            <textarea id="input-desc" maxlength="2048" style="width: 100%; height:100%;border-radius:5px;" placeholder="Enter description here."></textarea>
                        </div>
                    </div>
                    ...
                    <div class="container" style="padding-bottom:0px">
                        <div class="row" style="padding-top:2vh">
                            ...
                            <div class="col-10 col-sm-8 col-md-6 col-lg-4 col-xl-4">
                                <button type="button" class="btn btn-block btn-lg btn-success" onclick="submitProduct()">Submit</button>
                            </div>
                            <div class="col-1 col-sm-2 col-md-3 col-lg-4 col-xl-4"></div>
                        </div>
                    </div>
