                            ...
                            <div class="login-area">
                                <form class="form-lg" action="AuthServlet" method="post" onSubmit="return checkForm(this)">
                                    ...
                                    <div class="form-vertical">
                                        ...
                                        <p>
                                            <a style="color:cyan" class="create_link" href="login.jsp">Back to login</a>
                                        </p>
                                    </div>
...
<script>
    ...
    function checkForm(form)
    {
        ...
        // validation fails if password doesn't match password_confirm
